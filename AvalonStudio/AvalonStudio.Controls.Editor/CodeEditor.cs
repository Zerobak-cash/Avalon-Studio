...
namespace AvalonStudio.Controls.Editor
{
    public class CodeEditor : AvaloniaEdit.TextEditor
    {
        ...
        public CodeEditor() : base(new TextArea(), null)
        {
            ...
            //        if (s.OldValue != null)
            //        {
            //            foreach (var renderer in (ObservableCollection<VisualLineTransformer>)s.OldValue)
            //            {
            //                TextArea.TextView.LineTransformers.Remove(renderer);
            //            }
            //        }
            ...
            //        if (s.NewValue != null)
            //        {
            //            foreach (var renderer in (ObservableCollection<VisualLineTransformer>)s.NewValue)
            //            {
            //                TextArea.TextView.LineTransformers.Add(renderer);
            //            }
            //        }
        ...
        private void List_CollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
        {
            switch (e.Action)
            {
                case NotifyCollectionChangedAction.Add:
                    ...
                    {
                        TextArea.TextView.LineTransformers.Add(transformer as VisualLineTransformer);
                    }
                    break;
                ...
                case NotifyCollectionChangedAction.Remove:
                    ...
                    {
                        TextArea.TextView.LineTransformers.Remove(transformer as VisualLineTransformer);
                    }
                    break;
            }
        }

        public static readonly StyledProperty<Bitmap> ContextActionsIconProperty = AvaloniaProperty.Register<CodeEditor, Bitmap>(nameof(ContextActionsIcon));

        public Bitmap ContextActionsIcon
        {
        ...
        public static readonly StyledProperty<ObservableCollection<VisualLineTransformer>> DocumentLineTransformersProperty =
            AvaloniaProperty.Register<CodeEditor, ObservableCollection<VisualLineTransformer>>(nameof(DocumentLineTransformers), new ObservableCollection<VisualLineTransformer>());

        public ObservableCollection<VisualLineTransformer> DocumentLineTransformers
        {
