    ...
    public static class MetadataConverter
    {
        ...
        private static void PreProcessTypes(Dictionary<string, MetadataType> types, Metadata metadata)
        {
            ...
            var toAdd = new List<MetadataType>
            {
                ...
                new MetadataType(){ Name = "Avalonia.Media.Imaging.Bitmap" },
...
"FontSizeSmall","FontSizeNormal","FontSizeLarge"
            ...
            if (types.TryGetValue("Avalonia.Media.Imaging.Bitmap", out MetadataType bitmapType))
            {
                bitmapType.HasHintValues = true;
                bitmapType.HintValues = allresourceUrls.Where(r => isbitmaptype(r)).ToArray();
                bitmapType.XamlContextHintValuesFunc = (a, t, p) => filterLocalRes(bitmapType, a);
            }
            ...
            if (types.TryGetValue("Avalonia.Media.IImage", out MetadataType iImageType))
            {
                ...
                iImageType.XamlContextHintValuesFunc = (a, t, p) => filterLocalRes(bitmapType, a);
            }
            ...
            if (types.TryGetValue("Avalonia.Styling.StyleInclude", out MetadataType styleIncludeType))
            {
            ...
            if (types.TryGetValue("Avalonia.Styling.StyleIncludeExtension", out MetadataType styleIncludeExtType))
            {
