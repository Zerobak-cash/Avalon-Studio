...
BEING UPDATED TO 2025, NOT WORKING YET. Code updated and working on build errors.

An extensible, cross platform IDE written in C# for Embedded C/C++, .NET Core, Avalonia and Typescript
															Might add C# .csproj to this
...
```sh
git clone https://github.com/Zerobak-cash/Avalon-Studio --recursive
```
