...
namespace AvalonStudio.Debugging.Controls
{
    ...
    public class DisassemblyViewModel : ToolViewModel, IActivatableExtension
    {
        ...
        public DisassemblyViewModel() : base("Disassembly")
        {
            ...
            _lineTransformers = new ObservableCollection<VisualLineTransformer>();
        ...
        private ObservableCollection<VisualLineTransformer> _lineTransformers;

        public ObservableCollection<VisualLineTransformer> LineTransformers
        {
